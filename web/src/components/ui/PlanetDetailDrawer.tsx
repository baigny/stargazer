...
export const PlanetDetailDrawer: React.FC<PlanetDetailDrawerProps> = ({
  ...
  return (
    <aside className="fixed top-20 right-4 bottom-20 z-30 w-80 sm:w-96 bg-slate-900/70 backdrop-blur-2xl border border-cyan-500/30 rounded-3xl p-6 shadow-[0_16px_48px_rgba(0,0,0,0.8)] text-white overflow-y-auto space-y-6 animate-slide-left">
